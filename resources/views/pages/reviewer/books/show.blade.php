                                        ...
                                        <tbody>
                                            @foreach ($babs as $key => $bab)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($bab->status->option == 'Draft')
                                                            <span class="badge badge-secondary">{{ $bab->status->option }}</span>
                                                        @elseif($bab->status->option == 'Tersedia')
                                                        ...
                                                        @elseif($bab->status->option == 'Dikirim Author')
                                                            <span class="badge badge-info">{{ $bab->status->option }}</span>
                                                        ...
                                                        @elseif($bab->status->option == 'Revisi')
                                                            <span class="badge badge-danger">{{ $bab->status->option }}</span>
                                                        @elseif($bab->status->option == 'Direvisi')
                                                            <span class="badge badge-warning">{{ $bab->status->option }}</span>
