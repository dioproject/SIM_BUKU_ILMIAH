        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            @if ($currentChaptersCount < $totalChapters) <form action="{{ route('admin.store.chapter', $book->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf

                                @for ($i = $currentChaptersCount + 1; $i <= $totalChapters; $i++) <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-4 col-lg-2">Chapter
                                        {{ $i }}
                                        :</label>
                                    <div class="col-sm-12 col-md-10">
                                        <input type="text" tabindex="1" class="form-control" id="chapter" name="chapter[]" value="{{ old('chapter.' . ($i - 1)) }}">
                                    </div>
                        </div>
                        @endfor
                        ...
                        <ul class="list-group py-2">
                            <li class="list-group-item">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-right">
                                        ...
                                        <a class="btn btn-secondary" href="{{ Storage::url('upload/books/') . $chapter->book->template }}" download="{{ $chapter->book->template }}"><i class="fas fa-download"></i></a></td>
                                        @endif
                                        @if ($chapter->status->option == 'Submit')
                                        <a class="btn btn-success" href="{{ route('admin.approve.chapter', $chapter->id) }}" title="Approve"><i class="fas fa-check"></i></a>
                                        <a class="btn btn-danger" href="{{ route('admin.reject.chapter', $chapter->id) }}" title="Reject"><i class="fas fa-ban"></i></a>
                                        @endif
                                    </div>
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    ...
                                    <div class="col-md-1 text-right">
                                        <a class="btn btn-secondary" href="{{ Storage::url('upload/books/') . $chapter->file_chapter }}" download="{{ $chapter->file_chapter }}"><i class="fas fa-download"></i></a></td>
                                    </div>
                                    <div class="d-flex justify-content-between col-md-12 py-1">
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    ...
                                    <div class="col-md-1 text-right">
                                        <a class="btn btn-secondary" href="{{ Storage::url('upload/books/') . $chapter->file_review }}" download="{{ $chapter->file_review }}"><i class="fas fa-download"></i></a>
                                    </div>
                                    <div class="d-flex justify-content-between col-md-12 py-1">
