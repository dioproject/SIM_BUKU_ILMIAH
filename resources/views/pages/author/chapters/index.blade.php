            ...
            <div class="row">
                <div class="col-12">
                    <x-admin.card>
                        ...
                        <div class="card-body">
                            @if($chapters->count() > 0)
                                <x-admin.table :headers="['No', 'Judul Buku', 'Bab', 'Tanggal Dibuat', 'Status']">
                                    @foreach ($chapters as $key => $chapter)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                                <a href="{{ route('author.show.book', $chapter->buku->id) }}">
                                                    {{ $chapter->buku->judul }}
                                                </a>
                                            </td>
                            ...
                            @else
                                <div class="text-center py-5">
                                    ...
                                    <p class="text-muted">Anda belum ditugaskan untuk menulis bab apapun.</p>
                                </div>
                            @endif
                        </div>
