    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('author/royalty') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ url('author/royalty') }}"><i class="fas fa-solid fa-crown"></i><span>Royalty</span></a>
            </li>
            <li class="{{ Request::is('author/history') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ url('author/history') }}"><i class="fas fa-solid fa-clock-rotate-left"></i><span>History</span></a>
            </li>
        </ul>
    </aside>
</div>
