...
class AdminWorkflowFullTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        Jenis::create(['id' => 1, 'nama' => 'Pendidikan']);
    }
    ...
    {
        Buku::factory()->create(['judul' => 'Buku Matematika']);
        Buku::factory()->create(['judul' => 'Buku Fisika']);
    ...
    public function test_admin_can_store_book()
    {
        ...
        $this->assertDatabaseHas('bukus', ['judul' => 'Buku Baru', 'total_bab' => 5, 'jenis_id' => 1]);
    }

    public function test_admin_can_view_book_detail()
    {
        $buku = Buku::factory()->create(['jenis_id' => 1]);
    ...
    {
        $buku = Buku::factory()->create(['total_bab' => 2, 'judul' => 'Buku Test Merge']);
    ...
    {
        $buku = Buku::factory()->create(['total_bab' => 2]);
    ...
    {
        $buku = Buku::factory()->create(['total_bab' => 5]);
    ...
    {
        $buku = Buku::factory()->create(['judul' => 'Buku Final', 'total_bab' => 1]);
    ...
    {
        $buku = Buku::factory()->create(['judul' => 'Buku Katalog']);
        $finalisasi = Finalisasi::create(['buku_id' => $buku->id]);
        Katalog::create([
            'final_id' => $finalisasi->id,
            'judul' => 'Buku Katalog',
    ...
    {
        $buku = Buku::factory()->create(['judul' => 'Buku Katalog Test']);
        $finalisasi = Finalisasi::create([
            'buku_id' => $buku->id,
            'isbn' => '9786021234567',
            'cover' => 'cover.jpg',
    ...
    public function test_royalti_store_calculates_correctly()
    {
        ...
        $buku = Buku::factory()->create(['judul' => 'Buku Royalti', 'total_bab' => 2]);
    ...
    public function test_royalti_store_fails_when_bab_not_belonging_to_user()
    {
        ...
        $buku = Buku::factory()->create(['judul' => 'Buku Royalti Test', 'total_bab' => 1]);
        $chapter = Bab::factory()->create([
            'buku_id' => $buku->id,
    ...
    {
        $author = User::factory()->create(['user_role' => 'AUTHOR']);
        $buku = Buku::factory()->create(['judul' => 'Matematika Terapan', 'total_bab' => 1]);
        $chapter = Bab::factory()->create([
            'buku_id' => $buku->id,
            'author_id' => $author->id,
            'status_id' => Status::DISETUJUI,
